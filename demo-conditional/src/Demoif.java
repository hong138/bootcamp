...
public class Demoif {
    ...
    if (a > b) {
        ...
        // Approach
        boolean withoutSpecicalCharacter = false;
        if (password.length() >= 12) {
            withoutSpecicalCharacter = !password.contains("!") && !password.contains("@") && !password.contains("#") && !password.contains("$");
            if (!withoutSpecicalCharacter) {
                System.out.println("It is a strong password");
            } else {
                System.out.println("It is a weak password. No speical character");
            }
